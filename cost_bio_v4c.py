"""
Bio cost — variant v4c: v2c + LONGER HORIZON + MORE CANDIDATES.

Combine 4a and 4b. Test whether MPC search depth is the binding
constraint. If this jumps win rate but neither single change does,
search depth is the limit.
"""
