"""
Bio cost — variant v4a: v2c + LONGER MPC HORIZON.

Hypothesis: 8-step (3.2 s) horizon doesn't cover the full damage
exchange. Bio commits to a hold but can't see far enough ahead to
realize it'll need to engage 2 s later. Push horizon to 12 (4.8 s).
"""
